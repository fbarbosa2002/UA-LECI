...
public class ex_3 {
    public static void main(String[] args) {
        ...
        do{
            ...
            switch (choice) {
                case 1: tri = new Triangulo(read_doubleValue("Input Side 1 value: ", sc, 0.0, Double.MAX_VALUE), read_doubleValue("Input Side 2 value: ", sc, 0.0, Double.MAX_VALUE), read_doubleValue("Input Side 3 value: ", sc, 0.0, Double.MAX_VALUE)); break;
                case 2: cir = new Circulo(read_doubleValue("Input the radius: ", sc, 0.0, Double.MAX_VALUE)); break;
                case 3: rect = new Retangulo(read_doubleValue("Input the length: ", sc, 0.0, Double.MAX_VALUE), read_doubleValue("Input the height: ", sc, 0.0, Double.MAX_VALUE)); break;
                case 4: 
                    if(tri == null){
                        System.out.println("Triangle not defined");
                        break;
                    }
                    Triangulo compTri = new Triangulo(read_doubleValue("Input Side 1 value: ", sc, 0.0, Double.MAX_VALUE), read_doubleValue("Input Side 2 value: ", sc, 0.0, Double.MAX_VALUE), read_doubleValue("Input Side 3 value: ", sc, 0.0, Double.MAX_VALUE));
                ...
                case 5:
                    ...
                    Circulo compCir = new Circulo(read_doubleValue("Input the radius: ", sc, 0.0, Double.MAX_VALUE));
                ...
                case 6:
                    ...
                    Retangulo compRec = new Retangulo(read_doubleValue("Input the length: ", sc, 0.0, Double.MAX_VALUE), read_doubleValue("Input the height: ", sc, 0.0, Double.MAX_VALUE));
